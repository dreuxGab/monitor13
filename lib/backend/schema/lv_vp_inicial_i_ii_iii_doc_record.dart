...
class LvVpInicialIIiIiiDocRecord extends FirestoreRecord {
  LvVpInicialIIiIiiDocRecord._(
  ...
  // "Equip_ref" field.
  DocumentReference? _equipRef;
  DocumentReference? get equipRef => _equipRef;
  bool hasEquipRef() => _equipRef != null;
  ...
  void _initializeFields() {
    ...
    _equipRef = snapshotData['Equip_ref'] as DocumentReference?;
  }

  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('LV_VP_INICIAL_I_II_III_DOC');

  static Stream<LvVpInicialIIiIiiDocRecord> getDocument(
          DocumentReference ref) =>
      ref.snapshots().map((s) => LvVpInicialIIiIiiDocRecord.fromSnapshot(s));

  static Future<LvVpInicialIIiIiiDocRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => LvVpInicialIIiIiiDocRecord.fromSnapshot(s));

  static LvVpInicialIIiIiiDocRecord fromSnapshot(DocumentSnapshot snapshot) =>
      LvVpInicialIIiIiiDocRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static LvVpInicialIIiIiiDocRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      LvVpInicialIIiIiiDocRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'LvVpInicialIIiIiiDocRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is LvVpInicialIIiIiiDocRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createLvVpInicialIIiIiiDocRecordData({
...
class LvVpInicialIIiIiiDocRecordDocumentEquality
    implements Equality<LvVpInicialIIiIiiDocRecord> {
  const LvVpInicialIIiIiiDocRecordDocumentEquality();

  @override
  bool equals(LvVpInicialIIiIiiDocRecord? e1, LvVpInicialIIiIiiDocRecord? e2) {
    return e1?.prontuariodoFabricanteDisponivel ==
        ...
        e1?.equipRef == e2?.equipRef;
  }

  @override
  int hash(LvVpInicialIIiIiiDocRecord? e) => const ListEquality().hash([
  ...
  @override
  bool isValidKey(Object? o) => o is LvVpInicialIIiIiiDocRecord;
}
