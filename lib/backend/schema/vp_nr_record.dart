...
class VpNrRecord extends FirestoreRecord {
  VpNrRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('VP_NR');

  static Stream<VpNrRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => VpNrRecord.fromSnapshot(s));

  static Future<VpNrRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => VpNrRecord.fromSnapshot(s));

  static VpNrRecord fromSnapshot(DocumentSnapshot snapshot) => VpNrRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static VpNrRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      VpNrRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'VpNrRecord(reference: ${reference.path}, data: $snapshotData)';
...
Map<String, dynamic> createVpNrRecordData({
  String? index,
...
class VpNrRecordDocumentEquality implements Equality<VpNrRecord> {
  const VpNrRecordDocumentEquality();

  @override
  bool equals(VpNrRecord? e1, VpNrRecord? e2) {
  ...
  @override
  int hash(VpNrRecord? e) => const ListEquality().hash([
        e?.index,
        e?.ocupacaoHumana,
  ...
  @override
  bool isValidKey(Object? o) => o is VpNrRecord;
}
