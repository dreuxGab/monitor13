...
class LvCaldPeriodicaRecord extends FirestoreRecord {
  LvCaldPeriodicaRecord._(
  ...
  // "PrimeiraInpecaoPeriodica" field.
  String? _primeiraInpecaoPeriodica;
  String get primeiraInpecaoPeriodica => _primeiraInpecaoPeriodica ?? '';
  bool hasPrimeiraInpecaoPeriodica() => _primeiraInpecaoPeriodica != null;

  // "RelatoriosSegurancaDossier" field.
  String? _relatoriosSegurancaDossier;
  String get relatoriosSegurancaDossier => _relatoriosSegurancaDossier ?? '';
  bool hasRelatoriosSegurancaDossier() => _relatoriosSegurancaDossier != null;

  // "RelatoriosSegurancaDossier_aberta" field.
  String? _relatoriosSegurancaDossierAberta;
  String get relatoriosSegurancaDossierAberta =>
      _relatoriosSegurancaDossierAberta ?? '';
  bool hasRelatoriosSegurancaDossierAberta() =>
      _relatoriosSegurancaDossierAberta != null;

  // "RelatoriosSegurancaDossier_obs" field.
  String? _relatoriosSegurancaDossierObs;
  String get relatoriosSegurancaDossierObs =>
      _relatoriosSegurancaDossierObs ?? '';
  bool hasRelatoriosSegurancaDossierObs() =>
      _relatoriosSegurancaDossierObs != null;
  ...
  // "ManualdeInstruesdeOperaoComTodososProcedimentosAfins" field.
  String? _manualdeInstruesdeOperaoComTodososProcedimentosAfins;
  String get manualdeInstruesdeOperaoComTodososProcedimentosAfins =>
      _manualdeInstruesdeOperaoComTodososProcedimentosAfins ?? '';
  bool hasManualdeInstruesdeOperaoComTodososProcedimentosAfins() =>
      _manualdeInstruesdeOperaoComTodososProcedimentosAfins != null;

  // "ManualdeInstruesdeOperaoComTodososProcedimentosAfins_aberta" field.
  String? _manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta;
  String get manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta =>
      _manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta ?? '';
  bool hasManualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta() =>
      _manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta != null;

  // "ManualdeInstruesdeOperaoComTodososProcedimentosAfins_obs" field.
  String? _manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs;
  String get manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs =>
      _manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs ?? '';
  bool hasManualdeInstruesdeOperaoComTodososProcedimentosAfinsObs() =>
      _manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs != null;

  // "PrimeiraInspecaoPeriodica_aberta" field.
  String? _primeiraInspecaoPeriodicaAberta;
  String get primeiraInspecaoPeriodicaAberta =>
      _primeiraInspecaoPeriodicaAberta ?? '';
  bool hasPrimeiraInspecaoPeriodicaAberta() =>
      _primeiraInspecaoPeriodicaAberta != null;

  // "PrimeiraInspecaoPeriodica_obs" field.
  String? _primeiraInspecaoPeriodicaObs;
  String get primeiraInspecaoPeriodicaObs =>
      _primeiraInspecaoPeriodicaObs ?? '';
  bool hasPrimeiraInspecaoPeriodicaObs() =>
      _primeiraInspecaoPeriodicaObs != null;

  // "ManualInstrucoesOperacao_obs" field.
  String? _manualInstrucoesOperacaoObs;
  String get manualInstrucoesOperacaoObs => _manualInstrucoesOperacaoObs ?? '';
  bool hasManualInstrucoesOperacaoObs() => _manualInstrucoesOperacaoObs != null;
  ...
  void _initializeFields() {
    ...
    _primeiraInpecaoPeriodica =
        snapshotData['PrimeiraInpecaoPeriodica'] as String?;
    _relatoriosSegurancaDossier =
        snapshotData['RelatoriosSegurancaDossier'] as String?;
    _relatoriosSegurancaDossierAberta =
        snapshotData['RelatoriosSegurancaDossier_aberta'] as String?;
    _relatoriosSegurancaDossierObs =
        snapshotData['RelatoriosSegurancaDossier_obs'] as String?;
    ...
    _manualdeInstruesdeOperaoComTodososProcedimentosAfins =
        snapshotData['ManualdeInstruesdeOperaoComTodososProcedimentosAfins']
            as String?;
    _manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta = snapshotData[
            'ManualdeInstruesdeOperaoComTodososProcedimentosAfins_aberta']
        as String?;
    _manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs =
        snapshotData['ManualdeInstruesdeOperaoComTodososProcedimentosAfins_obs']
            as String?;
    _primeiraInspecaoPeriodicaAberta =
        snapshotData['PrimeiraInspecaoPeriodica_aberta'] as String?;
    _primeiraInspecaoPeriodicaObs =
        snapshotData['PrimeiraInspecaoPeriodica_obs'] as String?;
    _manualInstrucoesOperacaoObs =
        snapshotData['ManualInstrucoesOperacao_obs'] as String?;
    _responsavelEmail = snapshotData['ResponsavelEmail'] as String?;
  }

  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('LV_CALD_PERIODICA')
          : FirebaseFirestore.instance.collectionGroup('LV_CALD_PERIODICA');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('LV_CALD_PERIODICA').doc(id);

  static Stream<LvCaldPeriodicaRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => LvCaldPeriodicaRecord.fromSnapshot(s));

  static Future<LvCaldPeriodicaRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => LvCaldPeriodicaRecord.fromSnapshot(s));

  static LvCaldPeriodicaRecord fromSnapshot(DocumentSnapshot snapshot) =>
      LvCaldPeriodicaRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static LvCaldPeriodicaRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      LvCaldPeriodicaRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'LvCaldPeriodicaRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is LvCaldPeriodicaRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createLvCaldPeriodicaRecordData({
  ...
  String? contrato,
  bool? finalizada,
  String? primeiraInpecaoPeriodica,
  String? relatoriosSegurancaDossier,
  String? relatoriosSegurancaDossierAberta,
  String? relatoriosSegurancaDossierObs,
  String? interna,
  String? externa,
  String? tagEquipamento,
  String? internaExterna,
  String? manualdeInstruesdeOperaoComTodososProcedimentosAfins,
  String? manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta,
  String? manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs,
  String? primeiraInspecaoPeriodicaAberta,
  String? primeiraInspecaoPeriodicaObs,
  String? manualInstrucoesOperacaoObs,
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'PrimeiraInpecaoPeriodica': primeiraInpecaoPeriodica,
      'RelatoriosSegurancaDossier': relatoriosSegurancaDossier,
      'RelatoriosSegurancaDossier_aberta': relatoriosSegurancaDossierAberta,
      'RelatoriosSegurancaDossier_obs': relatoriosSegurancaDossierObs,
      'Interna': interna,
      'Externa': externa,
      'Tag_Equipamento': tagEquipamento,
      'internaExterna': internaExterna,
      'ManualdeInstruesdeOperaoComTodososProcedimentosAfins':
          manualdeInstruesdeOperaoComTodososProcedimentosAfins,
      'ManualdeInstruesdeOperaoComTodososProcedimentosAfins_aberta':
          manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta,
      'ManualdeInstruesdeOperaoComTodososProcedimentosAfins_obs':
          manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs,
      'PrimeiraInspecaoPeriodica_aberta': primeiraInspecaoPeriodicaAberta,
      'PrimeiraInspecaoPeriodica_obs': primeiraInspecaoPeriodicaObs,
      'ManualInstrucoesOperacao_obs': manualInstrucoesOperacaoObs,
...
class LvCaldPeriodicaRecordDocumentEquality
    implements Equality<LvCaldPeriodicaRecord> {
  const LvCaldPeriodicaRecordDocumentEquality();

  @override
  bool equals(LvCaldPeriodicaRecord? e1, LvCaldPeriodicaRecord? e2) {
    return e1?.prontuariodoFabricanteDisponivel ==
        ...
        e1?.primeiraInpecaoPeriodica == e2?.primeiraInpecaoPeriodica &&
        e1?.relatoriosSegurancaDossier == e2?.relatoriosSegurancaDossier &&
        e1?.relatoriosSegurancaDossierAberta ==
            e2?.relatoriosSegurancaDossierAberta &&
        e1?.relatoriosSegurancaDossierObs ==
            e2?.relatoriosSegurancaDossierObs &&
        e1?.interna == e2?.interna &&
        e1?.externa == e2?.externa &&
        e1?.tagEquipamento == e2?.tagEquipamento &&
        e1?.internaExterna == e2?.internaExterna &&
        e1?.manualdeInstruesdeOperaoComTodososProcedimentosAfins ==
            e2?.manualdeInstruesdeOperaoComTodososProcedimentosAfins &&
        e1?.manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta ==
            e2?.manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta &&
        e1?.manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs ==
            e2?.manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs &&
        e1?.primeiraInspecaoPeriodicaAberta ==
            e2?.primeiraInspecaoPeriodicaAberta &&
        e1?.primeiraInspecaoPeriodicaObs == e2?.primeiraInspecaoPeriodicaObs &&
        e1?.manualInstrucoesOperacaoObs == e2?.manualInstrucoesOperacaoObs &&
        e1?.responsavelEmail == e2?.responsavelEmail;
  }

  @override
  int hash(LvCaldPeriodicaRecord? e) => const ListEquality().hash([
        ...
        e?.contrato,
        e?.finalizada,
        e?.primeiraInpecaoPeriodica,
        e?.relatoriosSegurancaDossier,
        e?.relatoriosSegurancaDossierAberta,
        e?.relatoriosSegurancaDossierObs,
        e?.interna,
        e?.externa,
        e?.tagEquipamento,
        e?.internaExterna,
        e?.manualdeInstruesdeOperaoComTodososProcedimentosAfins,
        e?.manualdeInstruesdeOperaoComTodososProcedimentosAfinsAberta,
        e?.manualdeInstruesdeOperaoComTodososProcedimentosAfinsObs,
        e?.primeiraInspecaoPeriodicaAberta,
        e?.primeiraInspecaoPeriodicaObs,
        e?.manualInstrucoesOperacaoObs,
        e?.responsavelEmail
      ]);

  @override
  bool isValidKey(Object? o) => o is LvCaldPeriodicaRecord;
}
