...
class LvVpPeriodicaIIiIiiDocRecord extends FirestoreRecord {
  LvVpPeriodicaIIiIiiDocRecord._(
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('LV_VP_PERIODICA_I_II_III_DOC')
          : FirebaseFirestore.instance
              .collectionGroup('LV_VP_PERIODICA_I_II_III_DOC');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('LV_VP_PERIODICA_I_II_III_DOC').doc(id);

  static Stream<LvVpPeriodicaIIiIiiDocRecord> getDocument(
          DocumentReference ref) =>
      ref.snapshots().map((s) => LvVpPeriodicaIIiIiiDocRecord.fromSnapshot(s));

  static Future<LvVpPeriodicaIIiIiiDocRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => LvVpPeriodicaIIiIiiDocRecord.fromSnapshot(s));

  static LvVpPeriodicaIIiIiiDocRecord fromSnapshot(DocumentSnapshot snapshot) =>
      LvVpPeriodicaIIiIiiDocRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static LvVpPeriodicaIIiIiiDocRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      LvVpPeriodicaIIiIiiDocRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'LvVpPeriodicaIIiIiiDocRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is LvVpPeriodicaIIiIiiDocRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createLvVpPeriodicaIIiIiiDocRecordData({
...
class LvVpPeriodicaIIiIiiDocRecordDocumentEquality
    implements Equality<LvVpPeriodicaIIiIiiDocRecord> {
  const LvVpPeriodicaIIiIiiDocRecordDocumentEquality();

  @override
  bool equals(
      LvVpPeriodicaIIiIiiDocRecord? e1, LvVpPeriodicaIIiIiiDocRecord? e2) {
  ...
  @override
  int hash(LvVpPeriodicaIIiIiiDocRecord? e) => const ListEquality().hash([
  ...
  @override
  bool isValidKey(Object? o) => o is LvVpPeriodicaIIiIiiDocRecord;
}
