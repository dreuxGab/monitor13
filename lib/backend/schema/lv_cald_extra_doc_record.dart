...
class LvCaldExtraDocRecord extends FirestoreRecord {
  LvCaldExtraDocRecord._(
  ...
  // "AlteracaoLocal" field.
  String? _alteracaoLocal;
  String get alteracaoLocal => _alteracaoLocal ?? '';
  bool hasAlteracaoLocal() => _alteracaoLocal != null;
  ...
  void _initializeFields() {
    ...
    _alteracaoLocal = snapshotData['AlteracaoLocal'] as String?;
    _responsavelEmail = snapshotData['ResponsavelEmail'] as String?;
  }

  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('LV_CALD_EXTRA_DOC')
          : FirebaseFirestore.instance.collectionGroup('LV_CALD_EXTRA_DOC');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('LV_CALD_EXTRA_DOC').doc(id);

  static Stream<LvCaldExtraDocRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => LvCaldExtraDocRecord.fromSnapshot(s));

  static Future<LvCaldExtraDocRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => LvCaldExtraDocRecord.fromSnapshot(s));

  static LvCaldExtraDocRecord fromSnapshot(DocumentSnapshot snapshot) =>
      LvCaldExtraDocRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static LvCaldExtraDocRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      LvCaldExtraDocRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'LvCaldExtraDocRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is LvCaldExtraDocRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createLvCaldExtraDocRecordData({
...
class LvCaldExtraDocRecordDocumentEquality
    implements Equality<LvCaldExtraDocRecord> {
  const LvCaldExtraDocRecordDocumentEquality();

  @override
  bool equals(LvCaldExtraDocRecord? e1, LvCaldExtraDocRecord? e2) {
    return e1?.tubulacaoDanificadaporAcidente ==
        ...
        e1?.alteracaoLocal == e2?.alteracaoLocal &&
        e1?.responsavelEmail == e2?.responsavelEmail;
  }

  @override
  int hash(LvCaldExtraDocRecord? e) => const ListEquality().hash([
  ...
  @override
  bool isValidKey(Object? o) => o is LvCaldExtraDocRecord;
}
