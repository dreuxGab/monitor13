...
class LvVpPeriodicaIvVDocRecord extends FirestoreRecord {
  LvVpPeriodicaIvVDocRecord._(
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('LV_VP_PERIODICA_IV_V_DOC')
          : FirebaseFirestore.instance
              .collectionGroup('LV_VP_PERIODICA_IV_V_DOC');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('LV_VP_PERIODICA_IV_V_DOC').doc(id);

  static Stream<LvVpPeriodicaIvVDocRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => LvVpPeriodicaIvVDocRecord.fromSnapshot(s));

  static Future<LvVpPeriodicaIvVDocRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => LvVpPeriodicaIvVDocRecord.fromSnapshot(s));

  static LvVpPeriodicaIvVDocRecord fromSnapshot(DocumentSnapshot snapshot) =>
      LvVpPeriodicaIvVDocRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static LvVpPeriodicaIvVDocRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      LvVpPeriodicaIvVDocRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'LvVpPeriodicaIvVDocRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is LvVpPeriodicaIvVDocRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createLvVpPeriodicaIvVDocRecordData({
...
class LvVpPeriodicaIvVDocRecordDocumentEquality
    implements Equality<LvVpPeriodicaIvVDocRecord> {
  const LvVpPeriodicaIvVDocRecordDocumentEquality();

  @override
  bool equals(LvVpPeriodicaIvVDocRecord? e1, LvVpPeriodicaIvVDocRecord? e2) {
  ...
  @override
  int hash(LvVpPeriodicaIvVDocRecord? e) => const ListEquality().hash([
  ...
  @override
  bool isValidKey(Object? o) => o is LvVpPeriodicaIvVDocRecord;
}
