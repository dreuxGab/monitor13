...
class LvCaldInicialDocRecord extends FirestoreRecord {
  LvCaldInicialDocRecord._(
  ...
  // "ManualProcedimentosAfines" field.
  String? _manualProcedimentosAfines;
  String get manualProcedimentosAfines => _manualProcedimentosAfines ?? '';
  bool hasManualProcedimentosAfines() => _manualProcedimentosAfines != null;

  // "ManualProcedimentosAfines_aberta" field.
  String? _manualProcedimentosAfinesAberta;
  String get manualProcedimentosAfinesAberta =>
      _manualProcedimentosAfinesAberta ?? '';
  bool hasManualProcedimentosAfinesAberta() =>
      _manualProcedimentosAfinesAberta != null;

  // "ManualProcedimentosAfines_obs" field.
  String? _manualProcedimentosAfinesObs;
  String get manualProcedimentosAfinesObs =>
      _manualProcedimentosAfinesObs ?? '';
  bool hasManualProcedimentosAfinesObs() =>
      _manualProcedimentosAfinesObs != null;
  ...
  void _initializeFields() {
    ...
    _manualProcedimentosAfines =
        snapshotData['ManualProcedimentosAfines'] as String?;
    _manualProcedimentosAfinesAberta =
        snapshotData['ManualProcedimentosAfines_aberta'] as String?;
    _manualProcedimentosAfinesObs =
        snapshotData['ManualProcedimentosAfines_obs'] as String?;
    _responsavelEmail = snapshotData['ResponsavelEmail'] as String?;
  }

  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('LV_CALD_INICIAL_DOC')
          : FirebaseFirestore.instance.collectionGroup('LV_CALD_INICIAL_DOC');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('LV_CALD_INICIAL_DOC').doc(id);

  static Stream<LvCaldInicialDocRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => LvCaldInicialDocRecord.fromSnapshot(s));

  static Future<LvCaldInicialDocRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => LvCaldInicialDocRecord.fromSnapshot(s));

  static LvCaldInicialDocRecord fromSnapshot(DocumentSnapshot snapshot) =>
      LvCaldInicialDocRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static LvCaldInicialDocRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      LvCaldInicialDocRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'LvCaldInicialDocRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is LvCaldInicialDocRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createLvCaldInicialDocRecordData({
  ...
  String? manualProcedimentosAfines,
  String? manualProcedimentosAfinesAberta,
  String? manualProcedimentosAfinesObs,
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'ManualProcedimentosAfines': manualProcedimentosAfines,
      'ManualProcedimentosAfines_aberta': manualProcedimentosAfinesAberta,
      'ManualProcedimentosAfines_obs': manualProcedimentosAfinesObs,
...
class LvCaldInicialDocRecordDocumentEquality
    implements Equality<LvCaldInicialDocRecord> {
  const LvCaldInicialDocRecordDocumentEquality();

  @override
  bool equals(LvCaldInicialDocRecord? e1, LvCaldInicialDocRecord? e2) {
    return e1?.prontuariodoFabricanteDisponivel ==
        ...
        e1?.manualProcedimentosAfines == e2?.manualProcedimentosAfines &&
        e1?.manualProcedimentosAfinesAberta ==
            e2?.manualProcedimentosAfinesAberta &&
        e1?.manualProcedimentosAfinesObs == e2?.manualProcedimentosAfinesObs &&
        e1?.responsavelEmail == e2?.responsavelEmail;
  }

  @override
  int hash(LvCaldInicialDocRecord? e) => const ListEquality().hash([
        ...
        e?.interna,
        e?.internaExterna,
        e?.manualProcedimentosAfines,
        e?.manualProcedimentosAfinesAberta,
        e?.manualProcedimentosAfinesObs,
        e?.responsavelEmail
      ]);

  @override
  bool isValidKey(Object? o) => o is LvCaldInicialDocRecord;
}
