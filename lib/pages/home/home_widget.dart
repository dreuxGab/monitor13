                          ...
                          child: Wrap(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  valueOrDefault<String>(
                                    FFAppState().VPNR.length.toString(),
                                    '0',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .headlineMedium
                              ...
                              Padding(
                                ...
                                child: Text(
                                  valueOrDefault<String>(
                                    FFAppState().TUBVPNR.length.toString(),
                                    '0',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .headlineMedium
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    setState(() {
                                      FFAppState().VPNR = [];
                                      FFAppState().TUBVPNR = [];
                                      FFAppState().TUBCALDNR = [];
                                      FFAppState().TANQUESNR = [];
                                      FFAppState().CALDEIRASNR = [];
                                      FFAppState().isDataGotten = false;
                                    });
                                  },
                                  child: Text(
                                    valueOrDefault<String>(
