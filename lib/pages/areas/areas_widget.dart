...
class _AreasWidgetState extends State<AreasWidget>
  ...
  void initState() {
    ...
    _model.nameInputCreateAreaTextController ??= TextEditingController();
    _model.nameInputCreateAreaFocusNode ??= FocusNode();
                                  ...
                                  if (!(_model.modalCriar ? false : true))
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        setState(() {
                                          _model
                                              .nameInputCreateAreaTextController
                                              ?.clear();
                                        ...
                                        setState(() {
                                          _model
                                              .dropDownCreateAreaPlantaValueController
                                              ?.reset();
                                          _model
                                              .dropDownEditAreaPlantaValueController
                                              ?.reset();
                                        });
                                        setState(() {
                                    ...
                                    child: StreamBuilder<List<AreasRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemCount:
                                              listViewAreasRecordList.length,
                                          separatorBuilder: (_, __) =>
                                              SizedBox(height: 12.0),
                                          itemBuilder:
                                              (context, listViewIndex) {
                                            final listViewAreasRecord =
                                                listViewAreasRecordList[
                                                    listViewIndex];
                                            return Column(
                                              mainAxisSize: MainAxisSize.max,
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        setState(() {
                                                          _model.dropDownEditAreaPlantaValueController
                                                                  ?.value =
                                                              listViewAreasRecord
                                                                  .planta;
                                                        });
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: Text(
                                                                      valueOrDefault<
                                                                        ...
                                                                        dateTimeFormat(
                                                                            'd/M/y',
                                                                            listViewAreasRecord.createdTime),
                                                                        'dd/mm/yyyy',
                                                                      ),
                                                                      textAlign:
                                                                          TextAlign
                                                        ...
                                                        children: [
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onChanged: (val) =>
                                                                  setState(() =>
                                                                      _model.dropDownCreateAreaPlantaValue =
                                                                          val),
                                                              width: MediaQuery
                                                                          .sizeOf(
                                                                              context)
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: ((_model.nameInputCreateAreaTextController
                                                                              .text ==
                                                                          null ||
                                                                      _model.nameInputCreateAreaTextController
                                                                              .text ==
                                                                          '') ||
                                                                  (_model.dropDownCreateAreaPlantaValue ==
                                                                          null ||
                                                              ...
                                                              ? null
                                                              : () async {
                                                                  _model.confereNomeArea =
                                                                      await queryAreasRecordOnce(
                                                                    queryBuilder:
                                                                        (areasRecord) =>
                                                                            areasRecord.where(
                                                                      'Nome',
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          title:
                                                                              Text('Oops!'),
                                                                          content:
                                                                              Text('Parece que já existe uma área com este nome.'),
                                                                          actions: [
                                                                            TextButton(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              controller: _model
                                                                  ...
                                                                  FormFieldController<
                                                                      String>(
                                                                _model.dropDownEditAreaPlantaValue ??=
                                                                    _model
                                                                        .editarReTornoAction
                                                                        ?.planta,
                                                              ),
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            ...
                                                            if (confirmDialogResponse) {
                                                              _model.deleteUNIDEEQUIPStatus =
                                                                  await actions
                                                                      .deleteUNIDADESEEQUIPAMENTOS(
                                                                _model
                                                                    .editarReTornoAction!
                                                                    .nome,
                                                              );
                                                              if (_model
                                                                      .deleteUNIDEEQUIPStatus ==
                                                                  '200') {
                                                                await FFAppState()
                                                                    .editarAreas!
                                                                    .delete();
